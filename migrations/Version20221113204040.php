 ...
 */
final class Version20221113204040 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address DROP FOREIGN KEY FK_D4E6F8189329D25');
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F8189329D25 FOREIGN KEY (resource_id) REFERENCES resource (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE phone_number DROP FOREIGN KEY FK_6B01BC5B89329D25');
        $this->addSql('ALTER TABLE phone_number ADD CONSTRAINT FK_6B01BC5B89329D25 FOREIGN KEY (resource_id) REFERENCES resource (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE service_area DROP FOREIGN KEY FK_19D7898489329D25');
        $this->addSql('ALTER TABLE service_area ADD CONSTRAINT FK_19D7898454FFE465 FOREIGN KEY (resource_id) REFERENCES resource (id) ON DELETE CASCADE');
    }
}
